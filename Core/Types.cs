...
public class Types {
  public class PeerInfo {
    ...
    public List<string> sshHostKeys { get; set; }
  ...
  public class Prefs {
    ...
    public string InternalExitNodePrior { get; set; }
    ...
    public object AdvertiseTags { get; set; }
    public string Hostname { get; set; }
    public bool NotepadURLs { get; set; }
    public object AdvertiseRoutes { get; set; }
    ...
    public object DriveShares { get; set; }
